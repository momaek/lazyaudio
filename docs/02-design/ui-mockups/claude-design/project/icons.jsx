  ...
  glyph: {
    ...
    meeting: (s = 12) => (
      <svg
        ...
        strokeLinecap="round"
      >
        <circle cx="3.5" cy="4.5" r="1.4" />
        <circle cx="8.5" cy="4.5" r="1.4" />
        <path d="M1.5 10c.4-1.4 1.6-2.2 2-2.2M10.5 10c-.4-1.4-1.6-2.2-2-2.2" />
      </svg>
    ),
    note: (s = 12) => (
      <svg
    ...
    interviewer: (s = 12) => (
      <svg
        ...
        strokeLinejoin="round"
      >
        <rect x="2" y="4" width="8" height="6" rx="0.8" />
    ...
    candidate: (s = 12) => (
      <svg
        ...
        strokeLinejoin="round"
      >
        <circle cx="6" cy="4.2" r="1.8" />
        <path d="M2.5 10c.5-1.8 2-2.8 3.5-2.8s3 1 3.5 2.8" />
      </svg>
    ),
    lecture: (s = 12) => (
      <svg
        ...
        strokeLinejoin="round"
      >
        <path d="M1.5 4 6 2l4.5 2L6 6 1.5 4z" />
        <path d="M3.5 5v2.5c0 .8 1.1 1.5 2.5 1.5s2.5-.7 2.5-1.5V5" />
      </svg>
    ),
    podcast: (s = 12) => (
      <svg
        ...
        strokeLinecap="round"
      >
        <rect x="4.5" y="2" width="3" height="5" rx="1.5" />
        <path d="M3 6.5c0 1.5 1.3 2.7 3 2.7s3-1.2 3-2.7M6 9.2v1.3" />
      </svg>
    ),
  },
}
