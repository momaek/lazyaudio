...
function PreRecordDialog({ theme = 'light', typeKey = 'interviewer' }) {
  const TYPE_LABEL = {
    general: '通用', meeting: '会议', note: '笔记',
    interviewer: '面试官', candidate: '面试者',
    lecture: '课程', podcast: '播客',
  };
  return (
    <div className="prerec" data-theme={theme}>
      ...
      <div className="prerec-row">
        ...
        <div className="checkbox-stack">
          <label className="checkbox-row">
            <span className="cb is-on"><CheckMark/></span>
            <span>麦克风</span>
      ...
      <div className="prerec-hint">
        <span><span className="keys">⌘⇧R</span> 直接开始</span>
        <span><span className="keys">Esc</span> 取消</span>
      </div>
    </div>
  );
}
