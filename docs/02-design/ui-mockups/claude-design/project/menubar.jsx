    ...
    <div className={'mb-stage' + (theme === 'dark' ? ' dark' : '')} data-theme={theme}>
      ...
      <div className="mb-menu mb-submenu" style={{ top: 78, right: 440, width: 320, padding: 4 }}>
        ...
        <MenuRecentItem
          ...
          title="产品周会"
          when="10:00"
          preview="OK 我们先过一下本周的发布节奏…"
        />
        <MenuRecentItem
          type="note"
          title="关于 onboarding 卡顿的想法"
          when="昨天 16:45"
          preview="app 启动后第一屏到模型下载这段路径太长…"
        />
        <MenuRecentItem
          type="lecture"
          title="分布式系统 — 一致性算法"
          when="昨天 14:00"
          preview="我们今天主要讲 Paxos 和 Raft…"
        />
        <MenuRecentItem
          type="candidate"
          title="系统设计专项面（C 公司）"
          when="周四"
          preview="请你设计一个支持百万 QPS 的短链服务…"
        />
        <MenuSep />
