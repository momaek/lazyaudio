    ...
    <OnboardingShell step={1} theme={theme}>
      ...
      <div className="privacy-cards">
        ...
        <div className={'privacy-card' + (selected === 'cloud' ? ' is-selected' : '')}>
          ...
          <div className="desc">
            用你自己的 OpenAI 兼容 API key 转录。速度更快，但音频内容会发送至该服务。
          </div>
          <div className="meta-row">
...
function OnbDone({ theme }) {
  return (
    <OnboardingShell step={6} nextLabel="开始第一次录音" secondaryNext="先进入主窗口" theme={theme}>
      ...
      <p className="ob-sub">
        按{' '}
        <span
          style={{ fontFamily: 'var(--font-mono)', color: 'var(--text-base)', fontWeight: 600 }}
        >
          ⌘⇧R
        </span>{' '}
        开始你的第一次录音
      ...
      <div className="perm-list">
        ...
        <div className="perm-row">
          ...
          <div className="body">
            ...
            <div className="why">
              macOS 只允许通过屏幕录制 API 捕获系统音 — 我们不读取任何画面内容
            </div>
          </div>
        ...
        <div className="form-row">
          ...
          <div className="ctl">
            <input
              ...
              type="password"
              placeholder="sk-..."
              defaultValue="sk-proj-abCdEf1234567890QrStUvWx"
              readOnly
            />
