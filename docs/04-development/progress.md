...
| T17  | 状态保护                | ✅ done | feat/T17-state-protection ([#28](https://github.com/momaek/lazyaudio/pull/28)) + fix/T17-cmdw-close-menu | 2026-05-29 | 2026-05-30 | close→最小化/退出 + 退出确认 dialog + capture崩溃→partial;decideCloseAction 单测过;⌘W/killall/退出弹窗 真手测全过(权限通后);⌘W 补 Window 菜单 close 项 |
