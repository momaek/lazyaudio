...
> **最后更新**：2026-05-29
> **当前里程碑**：M3
> **当前焦点**：T16a / T15a 手测收尾 gated 在 T20 权限引导之后；下一候选 T17 状态保护 / T19 CI smoke / T20 权限引导
...
| T18  | 设置窗口骨架            | ✅ done | feat/T18-settings                                                        | 2026-05-29 | 2026-05-29 | settings-store(原子持久化)+ safeStorage 预留 + 通用/快捷键 tab;改快捷键 live re-register;AC 两半各有单测(reload roundtrip + applyEffects) |
